          ...
          >
            ...
            >
              <div className="mb-6">
                ...
                <div className="flex items-baseline mb-4">
                  <span className="text-4xl font-bold text-[#007991]">$0</span>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline mb-4">
                  <span className="text-4xl font-bold text-[#007991]">$10</span>
                  <span className="text-gray-500 ml-2">/month</span>
                </div>
                <p className="text-gray-600 mb-6">
            ...
            >
              <div className="mb-6">
                ...
                <div className="flex items-baseline mb-4">
                  <span className="text-4xl font-bold text-[#007991]">$25</span>
                  <span className="text-gray-500 ml-2">/month</span>
                </div>
                <p className="text-gray-600 mb-6">
